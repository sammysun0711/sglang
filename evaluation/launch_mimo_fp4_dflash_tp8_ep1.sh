...
export LOG_DIR="${LOG_DIR:-./logs/mimo_fp4_dflash_tp8_ep1_${RUN_ID}}"
export LOG_FILE="${LOG_FILE:-server_tp8_ep1.log}"

mkdir -p "${LOG_DIR}"

echo "Configuration: TP8/EP1, native MXFP4, DFlash, chunked-prefill=${CHUNKED_PREFILL_SIZE}, max-running=${MAX_RUNNING_REQUESTS}, mem=${MEM_FRACTION_STATIC}"
