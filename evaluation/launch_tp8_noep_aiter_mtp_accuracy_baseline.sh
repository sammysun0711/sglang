...
if [[ -v ROCM_QUICK_REDUCE_QUANTIZATION ]]; then
...
# Accuracy baseline: keep mixed router and FlyDSL prefill disabled even if the
# caller environment has optimization defaults set.
